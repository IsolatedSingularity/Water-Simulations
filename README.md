...
[![CI](https://img.shields.io/github/actions/workflow/status/IsolatedSingularity/Water-Simulations/ci.yml?branch=main&label=CI&logo=github)](https://github.com/IsolatedSingularity/Water-Simulations/actions/workflows/ci.yml)
